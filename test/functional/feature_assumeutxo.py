...
to a hash that has been compiled into alphacashd.
...
class AssumeutxoTest(AlphacashTestFramework):
    ...
    def test_invalid_mempool_state(self, dump_output_path):
        self.log.info("Test alphacashd should fail when mempool not empty.")
        node=self.nodes[2]
    ...
    def test_invalid_file_path(self):
        self.log.info("Test alphacashd should fail when file path is invalid.")
        node = self.nodes[0]
