...
"""
Test starting alphacashd with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(AlphacashTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that alphacashd has bound on "::1" (for RPC) and "::" (for P2P).
