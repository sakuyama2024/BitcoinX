...
By default, alphacashd will dump mempool on shutdown and
...
class MempoolPersistTest(AlphacashTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent alphacashd from writing mempool.dat to disk. Verify that `savemempool` fails")
