...
"""Verify that starting alphacash with -h works as expected."""

from test_framework.test_framework import AlphacashTestFramework
from test_framework.util import assert_equal

class HelpTest(AlphacashTestFramework):
    ...
    def run_test(self):
        self.log.info("Start alphacash with -h for help text")
        ...
        self.log.info("Start alphacash with -version for version information")
        ...
        self.log.info("Start alphacashd with -fakearg to make sure it does not start")
