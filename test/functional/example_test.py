...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the AlphacashTestFramework
    pass


class ExampleTest(AlphacashTestFramework):
    # Each functional test is a subclass of the AlphacashTestFramework class.
    ...
    def custom_method(self):
        ...
        AlphacashTestFramework class so other tests can use it."""
