...
class TestAlphacashCli(AlphacashTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `alphacash-cli getblockchaininfo`")
        ...
        self.log.info("Test -getinfo and alphacash-cli return all proxies")
        ...
        if self.is_specified_wallet_compiled():
            self.log.info("Test -getinfo and alphacash-cli getwalletinfo return expected wallet info")
            ...
            # Test alphacash-cli -generate with -rpcwallet in multiwallet mode.
