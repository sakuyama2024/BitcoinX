...
Verify that a alphacashd node can use an external signer command.
...
class RPCSignerTest(AlphacashTestFramework):
    ...
    def run_test(self):
        ...
        assert_raises_rpc_error(-1, 'Error: restart alphacashd with -signer=<cmd>',
