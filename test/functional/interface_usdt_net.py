...
"""  Tests the net:* tracepoint API interface.
     See https://github.com/alphacash/alphacash/blob/master/doc/tracing.md#context-net
"""
...
class NetTracepointTest(AlphacashTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("connect a P2P test node to our alphacashd node")
