...
class TestShell:
    """Wrapper Class for AlphacashTestFramework.

    The TestShell class extends the AlphacashTestFramework
    ...
    class __TestShell(AlphacashTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by AlphacashTestFramework child class.
            self.num_nodes = 1
