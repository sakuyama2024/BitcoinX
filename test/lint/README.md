...
```sh
DOCKER_BUILDKIT=1 docker build -t alphacash-linter --file "./ci/lint_imagefile" ./ && docker run --rm -v $(pwd):/alphacash -it alphacash-linter
```
...
maintained:
* for `src/secp256k1`: https://github.com/alphacash-core/secp256k1.git (branch master)
* for `src/leveldb`: https://github.com/alphacash-core/leveldb-subtree.git (branch alphacash-fork)
* for `src/crypto/ctaes`: https://github.com/alphacash-core/ctaes.git (branch master)
* for `src/crc32c`: https://github.com/alphacash-core/crc32c-subtree.git (branch alphacash-fork)
* for `src/minisketch`: https://github.com/sipa/minisketch.git (branch master)

To do so, add the upstream repository as remote:

```
git remote add --fetch secp256k1 https://github.com/alphacash-core/secp256k1.git
```
