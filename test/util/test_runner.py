...
"""Test framework for alphacash utils.
...
def main():
    ...
    bctester(os.path.join(env_conf["SRCDIR"], "test", "util", "data"), "alphacash-util-test.json", env_conf)
...
def bctest(testDir, testObj, buildenv):
    ...
    if testObj["exec"] == "./alphacash-util":
        execprog = os.getenv("ALPHACASHUTIL", default=execprog)
    elif testObj["exec"] == "./alphacash-tx":
        execprog = os.getenv("ALPHACASHTX", default=execprog)
    ...
    if "error_txt" in testObj:
        ...
        # That stderr is empty if no errors are expected. However, alphacash-tx
