...
{
    BOOST_CHECK(TestSplitHost("www.alphacashcore.org", "www.alphacashcore.org", 0));
    BOOST_CHECK(TestSplitHost("[www.alphacashcore.org]", "www.alphacashcore.org", 0));
    BOOST_CHECK(TestSplitHost("www.alphacashcore.org:80", "www.alphacashcore.org", 80));
    BOOST_CHECK(TestSplitHost("[www.alphacashcore.org]:80", "www.alphacashcore.org", 80));
    ...
    BOOST_CHECK(TestSplitHost("www.alphacashcore.org:65536", "www.alphacashcore.org:65536", 0, false));
    BOOST_CHECK(TestSplitHost("www.alphacashcore.org:0", "www.alphacashcore.org", 0, false));
    BOOST_CHECK(TestSplitHost("www.alphacashcore.org:", "www.alphacashcore.org:", 0, false));
}
