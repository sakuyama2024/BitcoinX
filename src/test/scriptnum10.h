...
#ifndef ALPHACASH_TEST_SCRIPTNUM10_H
#define ALPHACASH_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Alphacash Core 0.10.0, for cross-comparison.
 */
public:
...
#endif // ALPHACASH_TEST_SCRIPTNUM10_H
