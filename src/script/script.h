...
#ifndef ALPHACASH_SCRIPT_SCRIPT_H
#define ALPHACASH_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Alphacash always counted CHECKMULTISIGs
...
#endif // ALPHACASH_SCRIPT_SCRIPT_H
