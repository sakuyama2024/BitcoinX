...
#ifndef ALPHACASH_IPC_CAPNP_COMMON_TYPES_H
#define ALPHACASH_IPC_CAPNP_COMMON_TYPES_H
...
//! Functions to serialize / deserialize common alphacash types.
namespace mp {
...
#endif // ALPHACASH_IPC_CAPNP_COMMON_TYPES_H
