...
{
    // Test regression https://github.com/alphacash/alphacash/issues/24457. Ensure
...
{
    // Test that the bug https://github.com/alphacash-core/gui/issues/567 does not resurface.
    // It was fixed via https://github.com/alphacash-core/gui/pull/568.
    // With fListen=false in ~/.config/Alphacash/Alphacash-Qt.conf and all else left as default,
    // alphacash-qt should set both -listen and -listenonion to false and start successfully.
