...
//! Entry point for AlphacashApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &AlphacashApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for AlphacashGUI tests.
void AppTests::guiTests(AlphacashGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &AlphacashGUI::consoleShown, this, &AppTests::consoleTests);
