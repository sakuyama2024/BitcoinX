...
#ifndef ALPHACASH_QT_OPTIONSMODEL_H
#define ALPHACASH_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for Alphacash client.
...
public:
    ...
    AlphacashUnit getDisplayUnit() const { return m_display_alphacash_unit; }
...
private:
    ...
    QString language;
    AlphacashUnit m_display_alphacash_unit;
...
Q_SIGNALS:
    void displayUnitChanged(AlphacashUnit unit);
...
#endif // ALPHACASH_QT_OPTIONSMODEL_H
