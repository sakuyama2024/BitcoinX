...
#ifndef ALPHACASH_QT_GUIUTIL_H
#define ALPHACASH_QT_GUIUTIL_H
...
/** Utility functions used by the Alphacash Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "alphacash:" URI into recipient object, return true on successful parsing
