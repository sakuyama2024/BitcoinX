      ...
      ui(new Ui::OptionsDialog)
{
    ...
    ui->alphacashAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->alphacashAtStartup);
    ...
    ui->alphacashAtStartup->setToolTip(ui->alphacashAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->alphacashAtStartup->setText(ui->alphacashAtStartup->text().arg(PACKAGE_NAME));

    ui->openAlphacashConfButton->setToolTip(ui->openAlphacashConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new AlphacashUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->alphacashAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openAlphacashConfButton_clicked()
{
