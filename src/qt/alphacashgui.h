...
#ifndef ALPHACASH_QT_ALPHACASHGUI_H
#define ALPHACASH_QT_ALPHACASHGUI_H
...
/**
  Alphacash GUI main class. This class represents the main window of the Alphacash UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class AlphacashGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit AlphacashGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~AlphacashGUI();
    ...
    */
    ...
    /** Set the wallet model.
        The wallet model represents a alphacash wallet, and offers access to the list of transactions, address book and sending
        functionality.
    */
...
public Q_SLOTS:
    ...
    void incomingTransaction(const QString& date, AlphacashUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName);
#endif // ENABLE_WALLET
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Alphacash Transaction from file or clipboard */
...
private Q_SLOTS:
    ...
    void updateDisplayUnit(AlphacashUnit newUnits);
    /** Tells underlying optionsModel to update its current display unit. */
    void onMenuSelection(QAction* action);
};

#endif // ALPHACASH_QT_ALPHACASHGUI_H
