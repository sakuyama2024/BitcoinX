...
#ifndef ALPHACASH_UTIL_MESSAGE_H
#define ALPHACASH_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's alphacash address, it must refer to a public key.
...
#endif // ALPHACASH_UTIL_MESSAGE_H
