...
#ifndef ALPHACASH_INTERFACES_INIT_H
#define ALPHACASH_INTERFACES_INIT_H
...
//! (alphacash-gui, alphacash-node, alphacash-wallet, alphacashd, alphacash-qt) and each
...
#endif // ALPHACASH_INTERFACES_INIT_H
