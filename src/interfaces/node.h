...
#ifndef ALPHACASH_INTERFACES_NODE_H
#define ALPHACASH_INTERFACES_NODE_H
...
//! Top-level interface for a alphacash node (alphacashd process).
class Node
{
public:
    virtual ~Node() {}
    ...
    //! Return setting value from <datadir>/settings.json or alphacash.conf.
...
#endif // ALPHACASH_INTERFACES_NODE_H
