...
#ifndef ALPHACASH_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define ALPHACASH_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // ALPHACASH_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
