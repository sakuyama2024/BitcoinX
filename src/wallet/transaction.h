...
#ifndef ALPHACASH_WALLET_TRANSACTION_H
#define ALPHACASH_WALLET_TRANSACTION_H
...
public:
     ...
     * on this alphacash node, and set to 0 for transactions that were created
...
#endif // ALPHACASH_WALLET_TRANSACTION_H
