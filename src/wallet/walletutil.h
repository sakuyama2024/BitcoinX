...
#ifndef ALPHACASH_WALLET_WALLETUTIL_H
#define ALPHACASH_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! alphacash from opening the wallet, thinking it was newly created, and
...
#endif // ALPHACASH_WALLET_WALLETUTIL_H
