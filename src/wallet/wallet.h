...
#ifndef ALPHACASH_WALLET_WALLET_H
#define ALPHACASH_WALLET_WALLET_H
...
public:
     ...
     * alphacash-wallet tool code or by wallet migration code. If this is called
...
#endif // ALPHACASH_WALLET_WALLET_H
