...
// Copyright 2015 Alphacash Core Developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or https://opensource.org/licenses/mit-license.php.

#ifndef ALPHACASH_UNIVALUE_INCLUDE_UNIVALUE_H
#define ALPHACASH_UNIVALUE_INCLUDE_UNIVALUE_H
...
#endif // ALPHACASH_UNIVALUE_INCLUDE_UNIVALUE_H
