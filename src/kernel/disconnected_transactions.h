...
#ifndef ALPHACASH_KERNEL_DISCONNECTED_TRANSACTIONS_H
#define ALPHACASH_KERNEL_DISCONNECTED_TRANSACTIONS_H
...
#endif // ALPHACASH_KERNEL_DISCONNECTED_TRANSACTIONS_H
