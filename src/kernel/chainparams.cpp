...
//ALPHA TESTING
    ...
    printf("Genesis Block's Transaction Output scriptPubKey: %s\n", ScriptToAsmStr(genesis.vtx[0]->vout[0].scriptPubKey).c_str());
    ...
    printf("Transaction Details:\n");
       for (const auto& tx : genesis.vtx) {
           ...
           for (const auto& in : tx->vin) {
               printf("    Input Script: %s\n", ScriptToAsmStr(in.scriptSig).c_str());
           }
       }
...
//        consensus.nSubsidyHalvingInterval = 210000;
     ...
     // ALPHA modified for Alphcash two minutes
...
//ALPHA
      ...
      //  genesis = CreateGenesisBlock(1716649459, 2083236893, 0x1d00ffff, 1, 10 * COIN);
        
        genesis = CreateGenesisBlock(1716649459, 717013103, 0x1d00ffff, 1, 10 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        
        assert(genesis.hashMerkleRoot == uint256S("c61f9003735f01c77c4a8b3554b86b8bda7ce1f3854f1e657abfad6f49462614"));
        assert(consensus.hashGenesisBlock == uint256S("000000002ed4ae75a75ff7c755ddff6a92c77bbf9f621384585b434da0974bf7"));
...
//      assert(genesis.hashMerkleRoot == uint256S("0x4a5e1e4baab89f3a32518a88c31bc87f618f76673e2cc77ab2127b7afdeda33b"));
        ...
        vSeeds.emplace_back("seed.alphacash.sipa.be."); // Pieter Wuille, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("dnsseed.bluematt.me."); // Matt Corallo, only supports x9
        vSeeds.emplace_back("dnsseed.alphacash.dashjr-list-of-p2p-nodes.us."); // Luke Dashjr
        vSeeds.emplace_back("seed.alphacashstats.com."); // Christian Decker, supports x1 - xf
        vSeeds.emplace_back("seed.alphacash.jonasschnelli.ch."); // Jonas Schnelli, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.btc.petertodd.net."); // Peter Todd, only supports x1, x5, x9, and xd
        vSeeds.emplace_back("seed.alphacash.sprovoost.nl."); // Sjors Provoost
        vSeeds.emplace_back("dnsseed.emzy.de."); // Stephan Oeste
        vSeeds.emplace_back("seed.alphacash.wiz.biz."); // Jason Maurice
...
//      ALPHA NO POINT IN CALCULATING CORRECT NUMBERS
...
//
        ...
        vSeeds.emplace_back("testnet-seed.alphacash.jonasschnelli.ch.");
        vSeeds.emplace_back("seed.tbtc.petertodd.net.");
        vSeeds.emplace_back("seed.testnet.alphacash.sprovoost.nl.");
...
public:
    explicit SigNetParams(const SigNetOptions& options)
    {
        ...
        if (!options.challenge) {
            ...
            vSeeds.emplace_back("seed.signet.alphacash.sprovoost.nl.");
...
//ALPHA
        genesis = CreateGenesisBlock(1716649459, 0, 0x207fffff, 1, 10 * COIN);
     // genesis = CreateGenesisBlock(1716649459, 717013103, 0x207fffff, 1, 10 * COIN);
               
        consensus.hashGenesisBlock = genesis.GetHash();

//ALPHA
        assert(genesis.hashMerkleRoot == uint256S("c61f9003735f01c77c4a8b3554b86b8bda7ce1f3854f1e657abfad6f49462614"));
        assert(consensus.hashGenesisBlock == uint256S("25ea210148c80e5d232ef4bf96acbe17912dcbf18cd889fa75b69c1f181160b1"));
