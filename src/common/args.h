...
#ifndef ALPHACASH_COMMON_ARGS_H
#define ALPHACASH_COMMON_ARGS_H
...
extern const char * const ALPHACASH_CONF_FILENAME;
extern const char * const ALPHACASH_SETTINGS_FILENAME;
