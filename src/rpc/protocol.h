...
#ifndef ALPHACASH_RPC_PROTOCOL_H
#define ALPHACASH_RPC_PROTOCOL_H
...
enum RPCErrorCode
{
    ...
    // RPC_INTERNAL_ERROR should only be used for genuine errors in alphacashd
    ...
    //! P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  //!< Alphacash is not connected
...
#endif // ALPHACASH_RPC_PROTOCOL_H
