...
#ifndef ALPHACASH_ARITH_UINT256_H
#define ALPHACASH_ARITH_UINT256_H
...
public:
     ...
     *
     * Alphacash only uses this "compact" format for encoding difficulty
...
#endif // ALPHACASH_ARITH_UINT256_H
