...
#ifndef ALPHACASH_NODE_CONNECTION_TYPES_H
#define ALPHACASH_NODE_CONNECTION_TYPES_H
 ...
 * src/qt/guiutil.cpp and src/alphacash-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Alphacash’s Peer-to-Peer Network")
...
#endif // ALPHACASH_NODE_CONNECTION_TYPES_H
