...
export CONTAINER_NAME=ci_native_nowallet_libalphacashkernel
...
export GOAL="install"
export ALPHACASH_CONFIG="--enable-reduce-exports --enable-experimental-util-chainstate --with-experimental-kernel-lib --enable-shared"
