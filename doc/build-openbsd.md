...
This guide describes how to build alphacashd, command-line utilities, and GUI on OpenBSD.
...
...
to: /path/to/alphacash/depends/x86_64-unknown-openbsd
```

Then set `BDB_PREFIX`:

```bash
export BDB_PREFIX="/path/to/alphacash/depends/x86_64-unknown-openbsd"
```
...
(see issue [#6658](https://github.com/alphacash/alphacash/issues/6658)).
