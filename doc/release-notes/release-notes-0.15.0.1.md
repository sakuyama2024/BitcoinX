Alphacash Core version *0.15.0.1* is now available from:

  <https://alphacash.org/bin/alphacash-core-0.15.0.1/>

and

  <https://alphacashcore.org/bin/alphacash-core-0.15.0.1/>
