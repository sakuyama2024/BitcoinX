Alphacash Core version *0.15.2* is now available from:

  <https://alphacashcore.org/bin/alphacash-core-0.15.2/>
...
- #11554 `a69cc07` Sanity-check script sizes in alphacash-tx (TheBlueMatt)
