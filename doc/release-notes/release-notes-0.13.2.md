Alphacash Core version 0.13.2 is now available from:

  <https://alphacash.org/bin/alphacash-core-0.13.2/>
...
- #8908 `4a974b2` Update alphacash-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow alphacash-tx to create v2 transactions (btcdrak)
