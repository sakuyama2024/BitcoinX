Alphacash Core version 0.9.4 is now available from:

  https://alphacash.org/bin/0.9.4/
...
this update is incompatible with the Alphacash system and could lead to consensus
forks.

Alphacash Core released binaries from https://alphacash.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~alphacash/+archive/ubuntu/alphacash
- A third-party or self-compiled Alphacash Core

upgrade to Alphacash Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
