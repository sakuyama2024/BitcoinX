Alphacash version 0.5.4 is now available for download at:
http://sourceforge.net/projects/alphacash/files/Alphacash/alphacash-0.5.4/
...
http://gitorious.org/alphacash/alphacashd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix Alphacash-Qt notifications under Growl 1.3.
Increase required age of Alphacash-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxAlphacash properly when installing Alphacash-Qt over it. (Windows)
