...
Alphacash Core version 0.19.1 is now available from:

  <https://alphacashcore.org/bin/alphacash-core-0.19.1/>
...
From Alphacash Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Alphacash Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Alphacash Core does not yet change appearance when
...
- #17488 fix "alphacashd already running" warnings on macOS (fanquake)
