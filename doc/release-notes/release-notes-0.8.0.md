Alphacash-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/alphacash/files/Alphacash/alphacash-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Alphacash
...
New/changed settings (command-line or alphacash.conf file)
--------------------------------------------------------
