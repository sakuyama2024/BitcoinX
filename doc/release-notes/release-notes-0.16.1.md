Alphacash Core version 0.16.1 is now available from:

  <https://alphacashcore.org/bin/alphacash-core-0.16.1/>
...
- #12843 `df38b13` Test starting alphacashd with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure alphacashd processes are cleaned up when tests end (sdaftuar)
