Alphacash Core version 0.10.4 is now available from:

  <https://alphacash.org/bin/alphacash-core-0.10.4/>
...
- #6953 `43c2789` Split alphacash-tx into its own package
- #6953 `dfe0d4d` Include alphacash-tx binary on Debian/Ubuntu
