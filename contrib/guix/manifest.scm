...
(define* (make-alphacash-cross-toolchain target
                                       #:key
...
desirable for building Alphacash Core release binaries."
...
;; failure; see https://github.com/alphacash/alphacash/pull/27296.
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list ;; Native GCC 12 toolchain
                 ...
                 (make-alphacash-cross-toolchain target)))
