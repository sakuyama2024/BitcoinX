...
Arguments:
    <base_directory> - The base directory of a alphacash source code repository.
...
Arguments:
    <file> - A source file in the alphacash repository.
"""
...
USAGE = """
copyright_header.py - utilities for managing copyright headers of 'The Alphacash
