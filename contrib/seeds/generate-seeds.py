...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef ALPHACASH_CHAINPARAMSSEEDS_H\n')
    g.write('#define ALPHACASH_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the alphacash network\n')
    ...
    g.write('#endif // ALPHACASH_CHAINPARAMSSEEDS_H\n')
