...
complete --command alphacashd --no-files

# Extract options
function __fish_alphacashd_get_options
...
complete \
    --command alphacashd \
    --arguments "(__fish_alphacashd_get_options --nofiles)"
