...
# Extract options
function __fish_alphacash_tx_get_options
...
# Extract commands
function __fish_alphacash_tx_get_commands
...
# Add options
complete \
    --command alphacash-tx \
    --condition "not __fish_alphacash_seen_cmd (__fish_alphacash_tx_get_commands --commandsonly)" \
    --arguments "(__fish_alphacash_tx_get_options)" \
    --no-files

# Add commands
complete \
    --command alphacash-tx \
    --arguments "(__fish_alphacash_tx_get_commands)" \
    --no-files
