...
""" Interactive alphacashd P2P network traffic monitor utilizing USDT and the
    net:inbound_message and net:outbound_message tracepoints. """

# This script demonstrates what USDT for Alphacash Core can enable. It uses BCC
...
def main(alphacashd_path):
    ...
    alphacashd_with_usdts.enable_probe(
