...
"""Example logging Alphacash Core utxo set cache flushes utilizing
    the utxocache:flush tracepoint."""

# USAGE:  ./contrib/tracing/log_utxocache_flush.py path/to/alphacashd
...
def main(alphacashd_path):
    ...
    b = BPF(text=program, usdt_contexts=[alphacashd_with_usdts])
